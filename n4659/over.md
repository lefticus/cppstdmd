...
- Parameter declarations that differ only in the use of equivalent
  ...
  but only a synonym for another type ([[dcl.typedef]]). Enumerations,
  on the other hand, are distinct types and can be used to distinguish
...
type “pointer to function of (`P₁`, \dotsc, `Pₙ`) returning `R`”, or the
type “reference to pointer to function of (`P₁`, \dotsc, `Pₙ`) returning
`R`”, or the type “reference to function of (`P₁`, \dotsc, `Pₙ`)
