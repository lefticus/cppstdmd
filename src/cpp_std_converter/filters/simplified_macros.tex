...
%% Used by cpp-std-converter to reduce Lua filter complexity.
%%
...
\renewcommand{\cv}{cv}
\renewcommand{\cvqual}{cv-qualifier}
\renewcommand{\ntbs}{NTBS}
\renewcommand{\ntmbs}{NTMBS}
...
%%--------------------------------------------------
%% Category J: Phase 4 Additions (3 macros)
...
%%--------------------------------------------------
%% TOTAL: 80 simplified macros (75 original + 2 Phase 3 + 3 Phase 4 additions)
%% These cover ~73% of macro usage in the C++ standard source
%%
%% Macros removed after investigation (moved back to Lua filters):
%%  - \tcode{} - contains nested macros (\keyword{}, \ctype{}, \placeholder{}, etc)
%%  - \keyword{} - nested in \tcode{}, context-dependent (tables)
%%  - \ctype{} - nested in \tcode{}
%%  - \grammarterm{} - context-dependent (BNF vs text), nested in \opt{}
