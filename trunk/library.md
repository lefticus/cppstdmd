...
Several entities defined in [[support]] through [[thread]] and [[depr]]
...
the specification of a declaration `D` in [[support]] through [[thread]]
...
If a function defined in [[support]] through [[thread]] and [[depr]] is
...
described in [[support]] through [[thread]] and [[depr]] is a trivially
