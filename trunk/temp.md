...
with its iᵗʰ element. Such an element, in the context of the
...
The instantiation of P is the *id-expression* $\tcode{E}_K$.

When instantiating a *pack-index-specifier* P, let K be the index of P.
The instantiation of P is the *typedef-name* $\tcode{E}_K$.
